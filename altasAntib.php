...
<div id="Layer1">
    <?   $idMedicamento=$_REQUEST["idMedicamento"];   
		 ...
		 if ($i>0) { ?>   </p>   
		  <p>&nbsp; </p>   <p>     
		 <script language="JavaScript" type="text/javascript">   alert("El Medicamento ya existe");   location.href="altasAntib.html";   
		 </script>     
		 <?  }  else  {    
		 $nuevo="insert into medicamentos values ('".$idMedicamento."','".$nombM."','".$tipoM."','".$cantM."','".$stok."','".$precM."','".$tipo."','".$idCliente."','".$idDueña."')";   
